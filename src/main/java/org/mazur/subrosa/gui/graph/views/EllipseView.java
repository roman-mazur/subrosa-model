...
public class EllipseView extends VertexView {
   ...
   */
  public Point2D getPerimeterPoint(final EdgeView edge, final Point2D source, final Point2D p) {
  ...
  /**
   * Renderer for ellipses.
   * @author Roman Mazur (mailto: mazur.roman@gmail.com)
   */
  private static class EllipseViewRenderer extends VertexRenderer {
    private static final long serialVersionUID = -8164636099858358931L;
    /**
